        ...
        <div className="space-y-5">
            <div className="grid grid-cols-3 gap-5">
                {dataDashboard.map((item) => (
                    <div
                        key={item.id}
                        className="relative col-span-3 py-5 bg-white rounded-md shadow-lg lg:col-span-1"
                    >
            ...
            <div className="grid grid-cols-5 gap-5">
                <div className="col-span-5 p-5 bg-white rounded-md lg:col-span-3">
                    <h1 className="text-lg font-semibold text-primary">
                        Grafik Total Permohonan Saya Tahun{" "}
                        {new Date().getFullYear()}
                    </h1>
                    <div>
                        <ChartPermohonan data={chartMasyarakat} bulan={bulan} />
                    </div>
                </div>
